...
function BattleStatGuesser(formatid,modid){this.formatid=void 0;this.dex=void 0;this.moveCount=null;this.hasMove=null;this.ignoreEVLimits=void 0;this.supportsEVs=void 0;this.supportsAVs=void 0;
...
var stat=this.getStat(primaryStat,set,64,plusStat===primaryStat?1.1:1.0);
var ev=64;
...
var val=~~(~~(2*baseStat+iv+~~ev)*level/100+5);
if(!this.supportsEVs){
