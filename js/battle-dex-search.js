...
return true;
var modMoveData=BattleMovedex[id];
...
var _move2=dex.moves.get(_id13);
...
moves;_i24<_moves2.length;_i24++){var _id14=_moves2[_i24];
var isUsable=this.moveIsNotUseless(_id14,species,moves,this.set);
if(isUsable){
...
sketchMoves.length;_i26++){var _id15=sketchMoves[_i26];
var _isUsable=this.moveIsNotUseless(_id15,species,sketchMoves,this.set);
if(_isUsable){
