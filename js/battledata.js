...
if(_table.overrideItemDesc&&id in _table.overrideItemDesc){
data.shortDesc=_table.overrideItemDesc[id];
break;
}
}
...
if(_table2.overrideAbilityData&&id in _table2.overrideAbilityData){
Object.assign(data,_table2.overrideAbilityData[id]);
}
if(_table2.overrideAbilityDesc&&id in _table2.overrideAbilityDesc){
data.shortDesc=_table2.overrideAbilityDesc[id];
}
if(_table2.fullAbilityName&&id in _table2.fullAbilityName){
data.name=_table2.fullAbilityName[id];
data.exists=true;
}
}
var ability=new Ability(id,name,data);
